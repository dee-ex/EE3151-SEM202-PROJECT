...
Mô hình được huấn luyện qua 15 epoch như mô hình đầu tiên với một tập dữ liệu giàu hơn, gồm $18,000$ bức hình (so với $10,000$ của mô hình cũ) từ tập dữ liệu COCO.
