...
Cũng không thể quên cảm ơn một số anh khoá trên, các bạn cùng khoá và một vài cá nhân đã giúp đỡ em rất nhiều trong quá trình tìm hiểu đề tài cũng như thực hiện khảo sát lấy số liệu cho đánh giá kết quả của đồ án.\vspace{5pt}
...
\hspace{2cm}\textbf{Sinh Viên Thực Hiện}\vspace{10pt}\\
\hspace{2.3cm}Nguyễn Thành Trung
\end{tabular} 
\end{abstract}
...
Chất lượng của hai mô hình được so sánh định tính qua những kết quả thử nghiệm, cũng như định lượng qua hai giá trị là sai số toàn phương trung bình - MSE và sai số toàn phương trung bình gốc - RMSE của mỗi mô hình.\vspace{5pt}
...
\say{Là ý tưởng thú vị nhất về Học Máy trong vòng 10 năm qua.}\vspace{5pt}
